...
if __name__ == "__main__":
    ...
    print(f"Энтальпия: {enthalpy / 1000:.4f} кДж/Моль")

    delta_n = 0

    for reagent in r.get_reagents:
        delta_n -= Substance(reagent).find_substance_coefficient()[0]

    for product in r.get_products:
        delta_n += Substance(product).find_substance_coefficient()[0]
